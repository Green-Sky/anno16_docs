...
| `Volume`            | int, int, int                      | The volume of music, sound effects, and a value that correlates to progress in the main campaign. Values range from -4000 (minimum volume) to 0 (maximum volume) and -595 (new game) up to -580 (endgame).                                                                                                                                                                                                                                                                                                                                                                                        |
